  ...
  return getPlatform(title) === 'lin' ? (
    <div className="App-platform">
      ...
      <div className="App-platform-content">
        ...
        <a href="https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.0/linux-i386_1.0.0-alpha.4_MyCrypto.AppImage">
          32-bit
        </a>
        <a href="https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.0/linux-x86-64_1.0.0-alpha.4_MyCrypto.AppImage">
          64-bit
        </a>
      </div>
    </div>
