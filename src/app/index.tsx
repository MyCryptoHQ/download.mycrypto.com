...
const builds = [
  {
    name: 'macOS',
    link:
      'https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/mac_1.0.2-alpha.5_MyCrypto.dmg'
  },
  {
    name: 'Windows',
    link:
      'https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/windows_1.0.2-alpha.5_MyCrypto.exe'
  },
  {
    name: 'Linux',
    link:
      'https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/linux-x86-64_1.0.2-alpha.5_MyCrypto.AppImage'
  },
  {
    name: 'Stand Alone',
    link:
      'https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/standalone_1.0.2-alpha.5_MyCrypto.zip'
  }
];
      ...
      <div className="App-main-left">
        ...
        {OS === 'Linux' ? (
          <div className="App-linux-download-wrapper">
            <a
              href="https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/linux-i386_1.0.2-alpha.5_MyCrypto.AppImage"
            ...
            <a
              href="https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/linux-x86-64_1.0.2-alpha.5_MyCrypto.AppImage"
              className="App-download App-linux-download"
            >
              <i className="nc-icon nc-hit-down" />
              Download 64-bit
        ...
        <div className="App-other-links">
          ...
          <a
            href="https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/checksums.txt"
            className="App-other-links-release-notes"
          >
            checksums
          </a>
          <a
            href="https://github.com/MyCryptoHQ/MyCrypto/releases/download/1.0.2/checksums.txt.gpg"
            className="App-other-links-release-notes"
          >
            signed checksums
          </a>
